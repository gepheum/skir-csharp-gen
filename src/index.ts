...
class CsharpSourceFileGenerator {
  ...
  generate(): string {
    ...
    this.lines.push(
      ...
      "//   dotnet add package skir_client",
      "",
  ...
  private writeModuleInitAdapterFields(record: RecordLocation): void {
    ...
    if (record.record.recordType === "struct") {
      ...
      this.lines.push(" );");
      this.lines.push(
        ` public static readonly global::SkirClient.Serializer<${fqName}> ${name}_Serializer = ${name}_Adapter.ToSerializer();`,
      );
      this.lines.push("");
      return;
    }
    ...
    this.lines.push(" );");
    this.lines.push(
      ` public static readonly global::SkirClient.Serializer<${fqBase}> ${name}_Serializer = ${name}_Adapter.ToSerializer();`,
    );
    this.lines.push("");
  }
